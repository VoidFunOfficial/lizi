...
import { SDK_ABI_VERSION, SDK_ARTIFACT, SDK_ARTIFACT_SYMBOL_KEY } from "@fourier-video/core/protocol";
import type { FieldsSchema, InferFieldInputs, InferFields } from "./schema.ts";
import type { FourierShaderDefinition, FourierShaderFrame, FourierShaderUniformLayout, FourierShaderUniformValues } from "./webgl.ts";
export { SDK_ABI_VERSION, SDK_ARTIFACT, SDK_ARTIFACT_SYMBOL_KEY };
export declare const DESIGN_PREVIEW_FPS: 60;
export declare const MAX_DESIGN_PREVIEW_SECONDS: 30;
...
export interface FourierTimeline {
    animate(target: Element, keyframes: Keyframe[] | PropertyIndexedKeyframes, options?: FourierAnimationOptions): void;
}
...
export type MotionSubject = Exclude<React.ReactNode, undefined> | ((input: {
    frame: number;
...
export type ReactDesignPreview<Schema extends FieldsSchema> = DesignPreviewBase<Schema> & {
    subject?: never;
    motion?: never;
};
export type MotionDesignPreview<Schema extends FieldsSchema> = DesignPreviewBase<Schema> & {
    subject: MotionSubject;
    motion?: Partial<MotionTiming>;
};
/** Preview declaration for an FFmpeg-composited video Motion. */
export type VideoMotionDesignPreview<Schema extends FieldsSchema> = DesignPreviewBase<Schema> & {
    subject?: never;
    motion?: Partial<MotionTiming>;
};
export type ShaderDesignPreview<Schema extends FieldsSchema> = DesignPreviewBase<Schema> & {
...
type ShaderUniformDefinition<Schema extends FieldsSchema, Layout extends FourierShaderUniformLayout> = keyof Layout extends never ? {
    uniforms?: FourierShaderUniformValues<Layout> | ((input: ShaderUniformInput<Schema>) => FourierShaderUniformValues<Layout>);
} : {
    uniforms: FourierShaderUniformValues<Layout> | ((input: ShaderUniformInput<Schema>) => FourierShaderUniformValues<Layout>);
};
export type DomShaderDefinition<Schema extends FieldsSchema, Layout extends FourierShaderUniformLayout> = {
    name: string;
    schema: Schema;
...
export type DomMotionDefinition<Schema extends FieldsSchema> = DomMotionDefinitionBase<Schema> & ({
...
export type MotionDefinition<Schema extends FieldsSchema> = DomMotionDefinition<Schema> | DomFfmpegVideoMotionDefinition<Schema>;
export type ShaderDefinition<Schema extends FieldsSchema, Layout extends FourierShaderUniformLayout> = DomShaderDefinition<Schema, Layout>;
...
export interface DomReactArtifactMetadata<Schema extends FieldsSchema> extends ArtifactMetadataBase<Schema> {
    readonly kind: "react";
...
interface DomMotionArtifactMetadataBase<Schema extends FieldsSchema> extends ArtifactMetadataBase<Schema> {
...
export type DomMotionArtifactMetadata<Schema extends FieldsSchema> = DomMotionArtifactMetadataBase<Schema> & ({
...
export interface DomFfmpegVideoMotionArtifactMetadata<Schema extends FieldsSchema> extends ArtifactMetadataBase<Schema> {
    readonly kind: "motion";
...
export interface DomShaderArtifactMetadata<Schema extends FieldsSchema, Layout extends FourierShaderUniformLayout> extends ArtifactMetadataBase<Schema> {
...
export type ReactArtifactMetadata<Schema extends FieldsSchema> = DomReactArtifactMetadata<Schema>;
export type MotionArtifactMetadata<Schema extends FieldsSchema> = DomMotionArtifactMetadata<Schema> | DomFfmpegVideoMotionArtifactMetadata<Schema>;
export type ArtifactMetadata<Schema extends FieldsSchema> = ReactArtifactMetadata<Schema> | MotionArtifactMetadata<Schema> | DomShaderArtifactMetadata<Schema, FourierShaderUniformLayout>;
export type DomReactArtifact<Schema extends FieldsSchema> = ((props: InferFields<Schema>) => React.ReactNode) & {
    readonly [SDK_ARTIFACT]: DomReactArtifactMetadata<Schema>;
};
export type DomMotionArtifact<Schema extends FieldsSchema> = ((input: {
    subject: React.ReactNode;
    props: InferFields<Schema>;
}) => React.ReactNode) & {
    readonly [SDK_ARTIFACT]: DomMotionArtifactMetadata<Schema>;
};
...
export type DomShaderArtifact<Schema extends FieldsSchema, Layout extends FourierShaderUniformLayout> = ((input: ShaderComponentInput<Schema>) => React.ReactNode) & {
...
export type MotionArtifact<Schema extends FieldsSchema> = DomMotionArtifact<Schema> | DomFfmpegVideoMotionArtifact<Schema>;
export type ShaderArtifact<Schema extends FieldsSchema, Layout extends FourierShaderUniformLayout> = DomShaderArtifact<Schema, Layout>;
export type AnyArtifact = (((...args: any[]) => React.ReactNode) & {
...
export type ReactPreviewDefinition<Artifact extends AnyArtifact> = PreviewDefinitionBase<Artifact> & {
    subject?: never;
    motion?: never;
};
export type MotionPreviewDefinition<Artifact extends AnyArtifact> = PreviewDefinitionBase<Artifact> & {
    subject: MotionSubject;
    motion?: Partial<MotionTiming>;
};
export type VideoMotionPreviewDefinition<Artifact extends AnyArtifact> = PreviewDefinitionBase<Artifact> & {
    subject?: never;
    motion?: Partial<MotionTiming>;
};
export type ShaderPreviewDefinition<Artifact extends AnyArtifact> = PreviewDefinitionBase<Artifact> & {
    subject: string;
    motion?: never;
};
export type PreviewDefinition<Artifact extends AnyArtifact = AnyArtifact> = Artifact extends unknown ? Artifact[typeof SDK_ARTIFACT] extends ReactArtifactMetadata<any> ? ReactPreviewDefinition<Artifact> : Artifact[typeof SDK_ARTIFACT] extends DomFfmpegVideoMotionArtifactMetadata<any> ? VideoMotionPreviewDefinition<Artifact> : Artifact[typeof SDK_ARTIFACT] extends MotionArtifactMetadata<any> ? MotionPreviewDefinition<Artifact> : Artifact[typeof SDK_ARTIFACT] extends DomShaderArtifactMetadata<any, any> ? ShaderPreviewDefinition<Artifact> : never : never;
...
export type ReactPreviewConfig<Artifact extends AnyArtifact> = PreviewConfigBase<Artifact> & {
    subject?: never;
    motion?: never;
};
export type MotionPreviewConfig<Artifact extends AnyArtifact> = PreviewConfigBase<Artifact> & {
    subject: MotionSubject;
    motion?: Readonly<Required<MotionTiming>>;
};
export type VideoMotionPreviewConfig<Artifact extends AnyArtifact> = PreviewConfigBase<Artifact> & {
    subject?: never;
    motion?: Readonly<Required<MotionTiming>>;
};
export type ShaderPreviewConfig<Artifact extends AnyArtifact> = PreviewConfigBase<Artifact> & {
    subject: string;
    motion?: never;
};
export type PreviewConfig<Artifact extends AnyArtifact = AnyArtifact> = Artifact extends unknown ? Artifact[typeof SDK_ARTIFACT] extends ReactArtifactMetadata<any> ? ReactPreviewConfig<Artifact> : Artifact[typeof SDK_ARTIFACT] extends DomFfmpegVideoMotionArtifactMetadata<any> ? VideoMotionPreviewConfig<Artifact> : Artifact[typeof SDK_ARTIFACT] extends MotionArtifactMetadata<any> ? MotionPreviewConfig<Artifact> : Artifact[typeof SDK_ARTIFACT] extends DomShaderArtifactMetadata<any, any> ? ShaderPreviewConfig<Artifact> : never : never;
