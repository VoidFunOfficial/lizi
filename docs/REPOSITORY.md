...
- 旧官网 APK 移到本地 `outputs/android/legacy-download.apk`。官网使用 CNB Release 的固定附件地址。
- 新增 EditorConfig、Git attributes、Node 版本文件、开发与发布说明、CI/Release 配置，现已迁移至 CNB（参见 RELEASING.md）。
